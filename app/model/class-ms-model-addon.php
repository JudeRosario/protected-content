...
class MS_Model_Addon extends MS_Model_Option {
	...
	public function get_addon_list() {
		...
		$list[self::ADDON_INVITE_CODES] = (object) array(
			...
			'description' => __( 'Option to allow signups using invite codes. Invite codes can be tied to specific subscriptions and can be made mandatory for signups.', MS_TEXT_DOMAIN ),
		);
